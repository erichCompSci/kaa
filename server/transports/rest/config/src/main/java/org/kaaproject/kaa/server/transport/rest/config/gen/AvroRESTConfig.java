 ...
 */
package org.kaaproject.kaa.server.transport.rest.config.gen;  
@SuppressWarnings("all")
@org.apache.avro.specific.AvroGenerated
public class AvroRESTConfig extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroRESTConfig\",\"namespace\":\"org.kaaproject.kaa.server.transport.rest.config.gen\",\"fields\":[{\"name\":\"bindInterface\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"bindPort\",\"type\":\"int\"},{\"name\":\"publicInterface\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"publicPort\",\"type\":\"int\"},{\"name\":\"maxBodySize\",\"type\":\"int\"}]}");
   ...
   */
  public AvroRESTConfig() {}

  /**
   * All-args constructor.
   */
  public AvroRESTConfig(java.lang.String bindInterface, java.lang.Integer bindPort, java.lang.String publicInterface, java.lang.Integer publicPort, java.lang.Integer maxBodySize) {
  ...
  /** Creates a new AvroRESTConfig RecordBuilder */
  public static org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder newBuilder() {
    return new org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder();
  }
  
  /** Creates a new AvroRESTConfig RecordBuilder by copying an existing Builder */
  public static org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder newBuilder(org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder other) {
    return new org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder(other);
  }
  
  /** Creates a new AvroRESTConfig RecordBuilder by copying an existing AvroRESTConfig instance */
  public static org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder newBuilder(org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig other) {
    return new org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder(other);
  }
  
  /**
   * RecordBuilder for AvroRESTConfig instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroRESTConfig>
    implements org.apache.avro.data.RecordBuilder<AvroRESTConfig> {
    ...
    private Builder() {
      super(org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing AvroRESTConfig instance */
    private Builder(org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig other) {
            super(org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.SCHEMA$);
      if (isValidValue(fields()[0], other.bindInterface)) {
        this.bindInterface = data().deepCopy(fields()[0].schema(), other.bindInterface);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'bindInterface' field */
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder setBindInterface(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder clearBindInterface() {
      bindInterface = null;
    ...
    /** Sets the value of the 'bindPort' field */
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder setBindPort(int value) {
    ...
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder clearBindPort() {
    ...
    /** Sets the value of the 'publicInterface' field */
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder setPublicInterface(java.lang.String value) {
    ...
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder clearPublicInterface() {
    ...
    /** Sets the value of the 'publicPort' field */
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder setPublicPort(int value) {
    ...
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder clearPublicPort() {
    ...
    /** Sets the value of the 'maxBodySize' field */
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder setMaxBodySize(int value) {
    ...
    public org.kaaproject.kaa.server.transport.rest.config.gen.AvroRESTConfig.Builder clearMaxBodySize() {
      fieldSetFlags()[4] = false;
      return this;
    }

    @Override
    public AvroRESTConfig build() {
      try {
        AvroRESTConfig record = new AvroRESTConfig();
